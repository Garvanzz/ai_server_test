...
// TokenHeaderName 与 admin 前端 config tokenName 一致，请求头中携带的 token 键名
const TokenHeaderName = "xiaoxiaoxiyou"

// ContextKeyGmUser 存入 gin.Context 的当前 GM 用户 key
const ContextKeyGmUser = "gm_user"
...
const (
	...
	ERR_ACCOUNT_LOGIN_SERVER_MAINTAIN    = 1809 // 服务器维护
...
// 与 admin 前端约定：errcode=0(SUCCESS) 表示成功，前端 successCode 包含 0。
